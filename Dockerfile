...
RUN wget http://www.bio8.cs.hku.hk/clair3_trio/clair3_models/clair3_models.tar.gz -P /opt/models/clair3_models && \
	...
	wget http://www.bio8.cs.hku.hk/clair3_trio/clair3_nova_models/clair3_nova_models.tar.gz -P /opt/models/clair3_nova_models && \
    tar -zxvf /opt/models/clair3_nova_models/clair3_nova_models.tar.gz -C /opt/models/clair3_nova_models && \
    rm /opt/models/clair3_nova_models/clair3_nova_models.tar.gz && \
    cd /opt/bin && \
